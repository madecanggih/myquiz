...
@media (max-width: 992px) {
  ...
  <body style="font-family: 'Roboto', sans-serif">
    ...
    <div class="wrapping">
        ...
        <div class="container">
	     <center><h2>Ubah Tim</h2></center><br>
    ...
    <div class="form-group">
      <label for="nameteam">Ubah Nama Tim</label>
      <div class="input-group mb-3"><div class="input-group-prepend">
        <span class="input-group-text"><i class="fa fa-handshake-o"></i></span>
        </div>
        <input type="text" class="form-control <?php echo (!empty($nameteam_err)) ? 'is-invalid' : ''; ?>" value="<?php echo $value['name_team']; ?>" name = "nameteam" placeholder="Nama Tim" />
      </div>
