...
$query = mysqli_query( $link, "select id_question, question_name, question_image, option1, option2, option3, option4, option5, answer from tb_question where 1;");
  ...
  <script type="text/javascript">
    ...
    <div class="wrapping">
	    ...
	    <div class="content-wrapping" style="text-align: justify;">
          ...
          <center><h2>Daftar Soal</h2></center>
          ...
          <tbody>
                  ...
                  while ( $view = mysqli_fetch_assoc($query) ) {
                    ...
                    echo "<td>" . $view['option5'] . "</td>";
                    echo "<td>" . $view['answer'] . "</td>";
                    echo "<td> <a href=\"editquestion.php?id=$view[id_question]\">Ubah</a> </td>";
                    echo "<td> <a href=\"deletequestion.php?id=$view[id_question]\" onClick=\"return confirm('Anda yakin ingin menghapus?')\">Hapus</a> </td>";
                    echo "</tr>";
                  }
                  ?>
          </tbody>
