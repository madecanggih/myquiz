                    ...
                    if(mysqli_stmt_fetch($stmt)){
                        if(password_verify($password, $hashed_password)){
                          if($done==0){
                            ...
                            $error_msg = 'Anda telah menyelesaikan tes.';
                        }
                        } else{
                            // Display an error message if password is not valid
...
<div class="container" style="padding: 10% 0%;min-width: 30%; max-width: 80%; margin: 0 auto; ">
 ...
 <div class="card">
 <div class="card-header bg-primary text-white" align="center"><strong><h4>Masuk</h4></strong></div>
  ...
  <div class="card-body">
    ...
    <center>Silahkan <a href="register.php">klik disini</a> jika belum terdaftar.</center>
  	</form>
  </div>
